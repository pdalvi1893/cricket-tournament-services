...
function Tables() {
  ...
  const fetchItems = async () => {
    try {
      const res = await api(`${API_ENDPOINTS.LOOKUPS}?type=shot-timing`, { method: 'GET' })
              ...
              <TableRow key={team._id}>
                ...
                <TableCell>
                  <ul className="text-sm font-semibold list-disc list-inside">
                    {team.runs?.map((card: any, index: number) => (
