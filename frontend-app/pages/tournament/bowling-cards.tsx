...
function Tables() {
  ...
  const fetchItems = async () => {
    try {
      const res = await api(`${API_ENDPOINTS.LOOKUPS}?type=bowling-cards`, { method: 'GET' })
  ...
  return (
    <Layout>
      ...
      <GenericFormModal
        ...
        header="Add New Item"
        formFields={['name', 'all_shots_applicable', 'batting_cards']}
        ...
        <Table>
          <TableHeader>
            <tr>
              ...
              <TableCell>Bowling card</TableCell>
              <TableCell>All Shots Applicable</TableCell>
          ...
          <TableBody>
            {paginatedData.map((team) => (
              <TableRow key={team._id}>
                ...
                <TableCell>
                  <span className="text-sm font-semibold">{team.all_shots_applicable ? 'true' : 'false'}</span>
                </TableCell>
                <TableCell>
